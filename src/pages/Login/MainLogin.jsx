          ...
          <div className={"formWapper w-100"}>
            <div className={"loginForm mt-0"}>
              ...
              <div className="md-field md-theme-default md-has-value md-has-placeholder mb-2">
                <label className="position-static" htmlFor="md-input-k0xkm4usa">
                  Địa chỉ Email *
                </label>
                <input
                  value={email}
                ...
                >
                  <div className="md-ripple">
                    <div className="md-button-content">
                      <i onClick={()=> setShowPassword(prev=> !prev)} className="md-icon md-icon-font md-icon-image md-theme-default">
                        {
                          showPassword=== false &&
                          <svg
                            height={24}
